...
public class Helper {
    ...
    public static final String HELP_ELIMINARCATEGORIA = "ELIMINAR CATEGORIA \n"
            ...
            + "parametros: ELIMINARCATEGORIA [id_categoria]";
    ...
    public static final String HELP_ELIMINARENCARGADO = "ELIMINAR ENCARGADO \n"
            ...
            + "parametros: ELIMINARENCARGADO [id_encargado]";
    ...
    public static final String HELP_AGREGARITEM = "Agregar Item al carrito \n"
            ...
            + "parametros: AGREGARITEM [id_producto, cantidad]";
    ...
    public static final String HELP_AGREGARITEMP = "Agregar Item a una promocion \n"
            ...
            + "parametros: AGREGARITEMP [id_producto]";
    ...
    public static final String HELP_REGISTRARCLIENTE = "Registrar cliente \n"
            ...
            + "parametros: REGISTRARCLIENTE [nombre,apellido,direccion,email,password,telefono]";
    public static final String HELP_REGISTRARPRODUCTO = "Registrar producto \n"
            ...
            + "parametros: REGISTRARPRODUCTO [id_categoria,nombre,descripcion,fotosrc,precio]";
    public static final String HELP_MODIFICARPRODUCTO = "Modificar producto \n"
            ...
            + "parametros: MODIFICARPRODUCTO [id_producto,id_categoria,nombre,descripcion,fotosrc,precio]";
    ...
    public static final String HELP_MODIFICARCLIENTE = "Modificar cliente \n"
            ...
            + "parametros: MODIFICARCLIENTE [id_cliente,direccion,telefono]"
            + "";
    public static final String HELP_REGISTRARENCARGADO = "Registrar encargado \n"
            ...
            + "parametros: REGISTRARENCARGADO [nombre,apellido,email,password]";
    ...
    public static final String HELP_DATOSCLIENTE = "Datos cliente \n"
            ...
            + "parametros: DATOSCLIENTE [id_cliente]";
    public static final String HELP_REGISTRARORDEN = "Registrar orden \n"
            ...
            + "parametros: REGISTRARORDEN [id_orden,id_cliente,id_zona,id_producto,cantidad]";
    public static final String HELP_MODIFICARORDEN = "Modificar orden \n"
            ...
            + "parametros: MODIFICARORDEN [id_orden,id_cliente,id_producto,cantidad]";
    ...
    public static final String HELP_REGISTRARCATEGORIA = "Registrar categoria\n"
            ...
            + "parametros: REGISTRARCATEGORIA [nombre,descripcion]";
    public static final String HELP_MODIFICARCATEGORIA = "Modificar categoria\n"
            ...
            + "parametros: MODIFICARCATEGORIA [id_categoria,nombre,descripcion]";
    ...
    public static final String HELP_REGISTRARPROMOCION = "Registrar promocion\n"
            ...
            + "parametros: REGISTRARPROMOCION [nombre,descripcion,fecha_inicio dd-mm-yyyy,fecha_fin dd-mm-yyyy]";
    public static final String HELP_MODIFICARPROMOCION = "Modificar promocion\n"
            ...
            + "parametros: MODIFICARPROMOCION [id_promocion,nombre,descripcion,fecha_inicio,fecha_fin]";
    ...
    public static final String HELP_REGISTRARZONA = "REGISTRAR ZONA \n"
            ...
            + "Parametros: REGISTRARZONA [id_encargado,nombre,ubicacion] \n";


    public static final String HELP_MODIFICARZONA = "REGISTRAR ZONA \n"
            + "\n"
            + "El comando seleccionado registra una zona nueva de trabajo \n"
            + "Parametros: MODIFICARZONA [id_zona,id_encargado,nombre,ubicacion] \n";

    public static final String HELP_DATOSPROMOCION = "REGISTRAR ZONA \n"
            + "\n"
            + "El comando lista los productos que pertenecen a la promocion \n"
            + "Parametros: DATOSPROMOCION [id_promocion] \n";
}
