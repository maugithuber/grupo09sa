...
public class Helper {
    ...
    public static final String HELP_REGISTRARCLIENTE = "Registrar cliente \n"
            ...
            + "parametros: [nombre,apellido,id_usuario,email,password,tipousuario,telefono,direccion,id_persona]";
    ...
    public static final String HELP_REGISTRARENCARGADO = "Registrar encargado \n"
            ...
            + "parametros: [nombre,apellido,id_user,email,password,tipo,id_perona]";
    ...
    public static final String HELP_REGISTRARPROMOCION = "Registrar promocion\n"
            ...
            + "parametros: [nombre,descripcion,fecha_inicio,fecha_fin]";
